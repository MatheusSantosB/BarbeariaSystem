...
// Removi Validacao e LogUtils para evitar erros de dependencia se nao existirem
...
public class AgendamentoController implements Initializable {
    ...
    private void configurarTabela() {
        ...
        // --- CORREÇÃO IMPORTANTE DO ERRO DE CAST ---
        // Converte o Enum StatusAgendamento para String antes de exibir
    ...
    private void configurarHorarios() {
        ...
        // --- CORREÇÃO DO TYPO 'agro' para 'agora' ---
    ...
    private void atualizarStatus() {
        ...
        int pendentes = agendamentoService.contarAgendamentosPendentes();
        // Proteção contra o caso do label não existir no FXML antigo
